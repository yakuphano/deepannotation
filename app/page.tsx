...
export default function Home() {
  return (
    <main className="relative min-h-screen w-full bg-transparent overflow-x-hidden">
      ...
      {/* Arka Plan Görseli - Netlik için opacity düşürüldü */}
      ...
      <section className="container mx-auto px-6 relative z-20 w-full pt-28 md:pt-24 lg:pt-32">
        <div className="grid lg:grid-cols-2 gap-4 items-start">
          ...
          <div className="flex flex-col items-start text-left max-w-2xl animate-fade-in">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-400/20 border border-blue-400/30 text-blue-200 text-[10px] md:text-xs font-bold tracking-widest uppercase mb-1">
              <Zap size={14} />
            ...
            <p className="mt-6 text-white text-lg md:text-xl leading-relaxed font-medium max-w-xl drop-shadow-md opacity-90">
            ...
            <div className="flex flex-wrap gap-4 pt-6">
              <Link href="/contact" className="px-10 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-full font-bold transition-all flex items-center gap-2 group shadow-[0_0_30px_rgba(37,99,235,0.4)]">
                Get Started 
          ...
          <div className="relative flex items-center justify-end h-[350px] md:h-[600px] -mt-5 md:mt-0">
            <div className="w-full max-w-[750px] transform translate-x-12 md:translate-x-0 lg:translate-x-48 lg:translate-y-24 flex justify-center items-center scale-125 md:scale-150">
              <Lottie 
                ...
                loop={true} 
                className="w-full h-full opacity-100 drop-shadow-[0_0_80px_rgba(59,130,246,0.6)]"
              />
              <div className="absolute inset-0 bg-blue-400/30 blur-[150px] rounded-full -z-10"></div>
            </div>
          </div>
        </div>
      </section>
