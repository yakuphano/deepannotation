    ...
    bullets: [
      {
        ...
        imageUrl: usImage("photo-1518770660439-4636190af475", 1200, 800),
        imageAlt: "Electronic circuit board representing structured detection grids",
      },
      {
        label: "Polygon Segmentation",
        detail: "Exact contouring for irregular shapes and complex environments.",
        imageUrl: usImage("photo-1487958449943-daa9197fe770", 1200, 800),
        imageAlt: "Modern architecture with geometric shapes",
      },
      {
        label: "Polyline Annotation",
        detail: "Ideal for lane detection, wire recognition, and road markings.",
        imageUrl: usImage("photo-1502877338535-766e1452684c", 1200, 800),
        imageAlt: "Road and vehicle context for lane and path labeling",
      },
      {
        label: "Keypoint Labeling",
        detail: "Facial landmarks, skeletal tracking, and human pose estimation.",
        imageUrl: usImage("photo-1544005313-94ddf0286df2", 1200, 800),
        imageAlt: "Portrait photography suited to facial landmark concepts",
      },
      {
        label: "Semantic Segmentation",
        detail: "Pixel-level classification for scene understanding.",
        imageUrl: usImage("photo-1451187580459-43490279c0fa", 1200, 800),
        imageAlt: "Earth from space representing scene-level understanding",
      },
    ],
  },
  {
